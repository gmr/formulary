...
DHCPOptions = namedtuple('DHCPOptions',
                         ['id', 'logical_id', 'timestamp', 'status',
                          'domain_name', 'dns_servers', 'ntp_servers', 'tags'])

DHCPOptionsAssociation = namedtuple('DHCPOptionsAssociation',
                                    ['id', 'logical_id', 'timestamp', 'status'])

GatewayAssociation = namedtuple('GatewayAssociation', ['id', 'logical_id',
                                                       'timestamp', 'status'])

InternetGateway = namedtuple('InternetGateway', ['id', 'logical_id',
                                                 'timestamp', 'status'])

NetworkACL = namedtuple('NetworkACL', ['id', 'logical_id', 'timestamp',
                                       'status', 'entries', 'tags'])

NetworkACLEntry = namedtuple('NetworkACLEntry',
                             ['logical_id', 'timestamp', 'status', 'number',
                              'cidr_block', 'egress', 'action', 'protocol',
                              'from_port', 'to_port'])
...
Subnet = namedtuple('Subnet',
                    ['id', 'logical_id', 'timestamp', 'status',
                     'availability_zone', 'cidr_block', 'available_ips'])
