...
class CLI(object):
    ...
    def _create_parser(self):
        ...
        parser.add_argument('-c', dest='config_dir', default=default_path,
    ...
    def _run_cloudformation_command(args):
        obj = main.CloudFormation(args.profile,
                                  args.config_dir,
                                  args.type,
                                  args.name,
                                  args.dry_run,
